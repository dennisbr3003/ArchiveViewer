...
public class FragmentZipLibraryVideoFile extends Fragment implements IZipApplication {
    ...
    private boolean isPlaying = true, isLooping = true, isMuted = true;
    private long durationMs = 0;
    private Runnable progressUpdater;

    private int startPosition = 0;
    private String source, target, zipkey, filename;
    ...
    public static FragmentZipLibraryVideoFile newInstance(int position, String source, String target, String zipkey, String fileName) {
